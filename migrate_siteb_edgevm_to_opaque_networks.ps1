...
get-vm edge-01b | Get-NetworkAdapter -Name "Network adapter 2" | Set-NetworkAdapterOpaqueNetwork -OpaqueNetworkName siteb-edge-transportuplink1
get-vm edge-01b | Get-NetworkAdapter -Name "Network adapter 3" | Set-NetworkAdapterOpaqueNetwork -OpaqueNetworkName siteb-edge-transportuplink2

get-vm edge-02b | Get-NetworkAdapter -Name "Network adapter 2" | Set-NetworkAdapterOpaqueNetwork -OpaqueNetworkName siteb-edge-transportuplink1
get-vm edge-02b | Get-NetworkAdapter -Name "Network adapter 3" | Set-NetworkAdapterOpaqueNetwork -OpaqueNetworkName siteb-edge-transportuplink2
